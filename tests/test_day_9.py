...
class TestDay9Solutions:
    ...
    def test_part_1(self):
        assert part_1(self.test_day_9_data) == 13

    def test_part_2(self):
        assert part_2(self.test_day_9_data) == 1

    def teardown_class(self):
        LOG.info(f'Part 1 answer: {part_1(self.day_9_data)}')  # 6212
        LOG.info(f'Part 2 answer: {part_2(self.day_9_data)}')  # 2522
